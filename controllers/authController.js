...
exports.register = async (req, res) => {
   ...
   try {
      ...
      res.status(201).json({
         success: true,
         message: 'Tài khoản đã được tạo thành công. Vui lòng kiểm tra email để xác nhận tài khoản.',
         data: {
            id: user.id,
      ...
      error.message = 'Thất bại khi đăng ký tài khoản. Vui lòng kiểm tra lại thông tin.';
   ...
   try {
      ...
      if (!user.isVerified) {
         return res.status(403).json({
            success: false,
            error: 'Tài khoản chưa được xác thực email. Vui lòng xác thực email trước khi đăng nhập.'
         });
      }
