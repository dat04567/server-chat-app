...
exports.generatePresignedUrl = async (req, res) => {
  try {
    ...
    console.log(`got here brother media with fileName: ${fileName} and fileType: ${fileType}`)
    ...
    const allowedMimeTypes = {
      images: ['image/jpg', 'image/png', 'image/gif', 'image/jpeg'],
    ...
    // Log user activity
    console.log(`User ${userId} requested a pre-signed URL for ${uniqueFileName} (${fileType})`)
